...
class WayPointGoalState(SimpleActionState):
    ...
    def __init__(self, waypoint):
        super(WayPointGoalState, self).__init__(action_name='/move_base/goal',
    ...
    def goal_callback(userdata, goal, waypoint):
        ...
        pose_stamped.pose = waypoint_dict[waypoint]
        goal = MoveBaseActionGoal(goal=pose_stamped)
        return goal

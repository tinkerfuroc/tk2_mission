...
def main():
    ...
    with state:
        ...
        with sequence:
            sequence.add('1_Start', KeywordsRecognizeState(keywords='tinker'))
            ...
            sequence.add('4_turn_back', ChassisSimpleMoveState(theta=3.14)) 
            sequence.add('5_1_find_operator', FindOperator()) 
            sequence.add('5_2_point_operator', MonitorState(offset=Point(0, 0, 0), remapping={'target':'person_pose'})) 
